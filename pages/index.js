    ...
    <>
      ...
      <section className="home">
        ...
        <div className="block">
          ...
          <div className="textsku">Средняя маржинальность по продукту %</div>
          <div className="textskutwo">75</div>
          ...
          <div className="textvp">Средняя рентабельность по продукту %</div>
          <div className="textvptwo">27</div>
          ...
          <div className="textvm">Общая EBITDA</div>
          <div className="textvmtwo">147 000.00 рублей</div>
        ...
        <div className="textfintotal">Финансовые итоги проекта/магазина</div>
        <div className="textfintotaltitles">Финансовые показатели и коэффициенты, которые помогу увидеть общую картину работы с маркетплейсом. Работа с этими показатлями позволит планировать будущую прибыль и сокращать издержки.</div>
        ...
        <div className="ftotal">
          ...
          <div className="textrentabzatrattwo">75</div>
          ...
          <div className="textrentabprodazhtwo">27</div>
          ...
          <div className="textrentabsalesprodtwo">55</div>
          ...
          <div className="textrentabcleartwo">155</div>
          ...
          <div className="textrentabnooborotactivtwo">55</div>
          ...
          <div className="textebitdatwo">55</div>
          ...
          <div className="textrentab">Рентабельность</div>
          ...
          <div className="textmarjinprocenttwo">55</div>
          ...
          <div className="textviruchkatwo">55</div>
